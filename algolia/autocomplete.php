...
<script type="text/html" id="tmpl-autocomplete-taxon-suggestion">
	<a class="suggestion-link" href="{{ data.bdtfx.url }}" title="{{ data.bdtfx.scientific_name }}">
		<span class="suggestion-post-title">{{{ data._highlightResult.bdtfx.scientific_name.value }}}</span>
		<span class="suggestion-post-content">{{{ data._highlightResult.bdtfx.common_name.value }}}</span>
	</a>
</script>
