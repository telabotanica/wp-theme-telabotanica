...
function telabotanica_block_focus($data)
{
    $defaults = [
    ...
    if (!$data->display_buttons) {
        $data->display_buttons = [];
    }
    ...
    $data->modifiers[] = 'with-background-image'; elseif ($data->background === 'color' && $data->background_color) :
