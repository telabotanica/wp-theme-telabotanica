...
<?php if ('upload-image' == bp_get_avatar_admin_step()) : ?>
	...
	<?php if (bp_get_group_has_avatar()) : ?>
		...
		<?php bp_button(['id' => 'delete_group_avatar', 'component' => 'groups', 'wrapper_id' => 'delete-group-avatar-button', 'link_class' => 'edit', 'link_href' => bp_get_group_avatar_delete_link(), 'link_text' => __('Delete Group Profile Photo', 'buddypress')]); ?>
