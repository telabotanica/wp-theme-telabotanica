		...
		<?php while (bp_group_membership_requests()) : bp_group_the_membership_request(); ?>
			...
			<li class="item-list group-request-list">
				...
				<div class="action">
					...
					<?php bp_button(['id' => 'group_membership_accept', 'component' => 'groups', 'wrapper_class' => 'accept', 'link_href' => bp_get_group_request_accept_link(), 'link_text' => __('Accept', 'buddypress')]); ?>

					<?php bp_button(['id' => 'group_membership_reject', 'component' => 'groups', 'wrapper_class' => 'reject', 'link_href' => bp_get_group_request_reject_link(), 'link_text' => __('Reject', 'buddypress')]); ?>
