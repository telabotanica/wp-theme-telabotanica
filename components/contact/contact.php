...
function telabotanica_component_contact($data)
{
    $defaults = [
		'image'				   => '',
		'name'				    => '',
    ...
    if (!empty($data->image)) :
			echo '<div class="component-contact-image" style="background-image: url(' . $data->image . ')"></div>'; else :
    ...
    if (!empty($data->phone)) {
        echo '<li><a href="tel:' . str_replace(' ', '', $data->phone) . '" class="component-contact-phone">' . $data->phone . '</a></li>';
    }
    if (!empty($data->email)) {
        echo '<li><a href="mailto:' . $data->email . '" class="component-contact-email">' . $data->email . '</a></li>';
    }
    if (!empty($data->website)) {
        echo '<li><a href="' . $data->website . '" target="_blank" rel="noopener noreferrer" class="component-contact-website">' . $data->website . '</a></li>';
    }
    echo '</ul>';
