			...
			<div class="layout-wrapper">
				<div class="footer-about-tela layout-column">
					...
					<div class="footer-about-tela-details">
						...
						<div class="footer-about-tela-details-tel"><?php _e('Téléphone', 'telabotanica') ?> : +33 (4) 67 52 41 22</div>
    ...
    if ($footer_no_newsletter !== true) {
		...
		<?php if (has_nav_menu('footer-bar')) : ?>
			<nav class="footer-nav-bar" role="navigation" aria-label="<?php esc_attr_e('Menu de pied de page', 'telabotanica'); ?>">
				...
				<a href="https://creativecommons.org/licenses/by-sa/4.0/deed.<?php echo ICL_LANGUAGE_CODE ?>" target="_blank" rel="nofollow" class="footer-nav-license"><?php the_telabotanica_module('icon', ['icon' => 'cc']) ?> BY-SA 4.0</a>
			</nav>
		<?php endif; ?>
	</footer><!-- .site-footer -->
<?php 
